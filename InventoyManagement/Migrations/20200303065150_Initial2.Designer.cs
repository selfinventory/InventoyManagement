...
namespace InventoyManagement.Migrations
{
    ...
    [Migration("20200303065150_Initial2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InventoyManagement.Models.ModelPartsModel", b =>
                {
                    ...
                    b.Property<string>("ModelPartsBrandsBrandID")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
                    ...
                    b.HasIndex("ModelPartsBrandsBrandID");
            ...
            modelBuilder.Entity("InventoyManagement.Models.PartsFotoModel", b =>
                {
                    ...
                    b.Property<DateTime>("PartsFotoCreated")
                        .HasColumnType("datetime(6)");
                    ...
                    b.Property<DateTime>("PartsFotoUpdate")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("InventoyManagement.Models.PartsGroupModel", b =>
                {
                    ...
                    b.Property<string>("PartsGroupModelIDModelPartsID")
                        .HasColumnType("varchar(255) CHARACTER SET utf8mb4");
                    ...
                    b.HasIndex("PartsGroupModelIDModelPartsID");
            ...
            modelBuilder.Entity("InventoyManagement.Models.ModelPartsModel", b =>
                {
                    b.HasOne("InventoyManagement.Models.BrandsModel", "ModelPartsBrands")
                        .WithMany()
                        .HasForeignKey("ModelPartsBrandsBrandID");
                });

            modelBuilder.Entity("InventoyManagement.Models.PartsGroupModel", b =>
                {
                    b.HasOne("InventoyManagement.Models.ModelPartsModel", "PartsGroupModelID")
                        .WithMany()
                        .HasForeignKey("PartsGroupModelIDModelPartsID");
                });
